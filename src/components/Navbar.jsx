    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-400 ease-in-out backdrop-blur-xl border-b ${
      ...
      <div className="w-full mx-auto px-3 sm:px-4 md:px-6 lg:px-8 max-w-[1400px]">
        <div className="flex items-center justify-between py-2.5 sm:py-3 md:py-3.5 lg:py-4">
          <Link to="/" className="flex items-center gap-0 text-lg sm:text-xl md:text-2xl lg:text-3xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-gray-600 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300 z-50 flex-shrink-0">
          ...
          <div className={`lg:hidden fixed left-0 right-0 bg-white dark:bg-slate-900 shadow-2xl border-t border-gray-200 dark:border-slate-700 transition-all duration-300 ease-in-out z-40 ${
            isMobileMenuOpen ? 'opacity-100 translate-y-0 visible top-[48px] sm:top-[52px] md:top-[56px]' : 'opacity-0 -translate-y-4 invisible top-[48px] sm:top-[52px] md:top-[56px]'
          }`}>
            <div className="px-3 sm:px-4 md:px-6 py-4 sm:py-5 md:py-6 space-y-1 max-h-[calc(100vh-48px)] sm:max-h-[calc(100vh-52px)] md:max-h-[calc(100vh-56px)] overflow-y-auto">
              ...
              <Link 
                to="/contact" 
                className="block w-full text-center px-4 sm:px-6 py-2.5 sm:py-3 mt-3 sm:mt-4 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base text-white bg-gradient-to-r from-blue-600 to-blue-700 shadow-lg shadow-blue-600/35 hover:shadow-xl hover:shadow-blue-600/45 transition-all duration-400"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Get Started
              </Link>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-4 flex-shrink-0">
            ...
            >
              <div className={`relative w-10 h-5 sm:w-11 sm:h-6 md:w-12 md:h-6 lg:w-14 lg:h-7 rounded-full transition-all duration-400 ease-in-out border-2 ${
                isDarkMode 
                ...
                <div className={`absolute top-1/2 -translate-y-1/2 w-[16px] h-[16px] sm:w-[18px] sm:h-[18px] md:w-[20px] md:h-[20px] lg:w-[22px] lg:h-[22px] rounded-full flex items-center justify-center shadow-[0_3px_10px_rgba(37,99,235,0.3),0_1px_3px_rgba(0,0,0,0.1)] transition-all duration-[400ms] ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${
                  isDarkMode 
            ...
            >
              <span className={`block w-[18px] sm:w-5 md:w-6 h-[2px] sm:h-0.5 bg-gray-800 dark:bg-gray-200 transition-all duration-300 ${isMobileMenuOpen ? 'rotate-45 translate-y-[5px] sm:translate-y-[6px] md:translate-y-2' : ''}`}></span>
              <span className={`block w-[18px] sm:w-5 md:w-6 h-[2px] sm:h-0.5 bg-gray-800 dark:bg-gray-200 transition-all duration-300 ${isMobileMenuOpen ? 'opacity-0' : ''}`}></span>
              <span className={`block w-[18px] sm:w-5 md:w-6 h-[2px] sm:h-0.5 bg-gray-800 dark:bg-gray-200 transition-all duration-300 ${isMobileMenuOpen ? '-rotate-45 -translate-y-[5px] sm:-translate-y-[6px] md:-translate-y-2' : ''}`}></span>
            </button>
          </div>
        </div>
